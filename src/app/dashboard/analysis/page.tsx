...
export default async function AnalysisPage({ searchParams }: { searchParams: { [key: string]: string | undefined } }) {
  ...
  if (!moduleName) {
    return <div className="p-10 text-center">Module parameter is missing. Cannot analyze.</div>;
  }
